<?php
	...
	$result = mysqli_query($con, "select * from PatientLogin where P_name = '$user'");
	...
	<div class="row">
      ...
      <div class="col-md-3">
        <div class="text-center">
          <img id="myimage" src="img/download.jpeg" class="avatar img-circle" alt="avatar">
          <h1></h1>
          <input id="image" type="file" class="form-control" onchange="readURL(this);">
        </div>
      </div>
